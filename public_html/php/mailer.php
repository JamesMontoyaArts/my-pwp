...
try {
	...
	// this assumes jQuery (not Angular will be submitting the form, so we're using the $_POST superglobal (take into account for each name field we created on our form unique to our website)
